        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grupo_Escuela_EscuelaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empleado_Escuela_EscuelaId",
                        column: x => x.EscuelaId,
                        principalTable: "Escuela",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Empleado_Grupo_GrupoId",
                        column: x => x.GrupoId,
                        principalTable: "Grupo",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Empleado_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Empleado_EscuelaId",
                table: "Empleado",
                column: "EscuelaId");

            migrationBuilder.CreateIndex(
                name: "IX_Empleado_GrupoId",
                table: "Empleado",
                column: "GrupoId");

            migrationBuilder.CreateIndex(
                name: "IX_Empleado_RoleId",
                table: "Empleado",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Grupo_EscuelaId",
                table: "Grupo",
                column: "EscuelaId");
        }
